/*
 * Uses CS 122B Project 4. Autocomplete Example.
 *
...
function handleLookup(query, doneCallback) {
    ...
    if (cache != null) {
        console.log("getting cached suggestions");
        ...
        jQuery.ajax({
            ...
            "url": "api/search-movie?query=" + query,
...
function handleSearch(query) {
    ...
    window.location.href = `movie-list.html?title=${query}&pageNumber=1`;
}
...
$('#search-button').click(() => {
    window.location.href = `movie-list.html?title=${$('#autocomplete').val()}&pageNumber=1`;
})
